-- ПАТЧ №19 — ФИНАЛЬНАЯ ВЕРСИЯ с исправлениями
-- Обновление базы данных для поддержки новых полей и исправления конфликтов
...
-- 12. Проверяем, что все таблицы существуют
